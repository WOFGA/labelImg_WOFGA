...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def open_next_image(self, _value=False):
        ...
        filename = None
        if self.file_path is None:
            try: ######### "WOFGA" FIX labeling issue when restarting labeling #######
                filename = self.m_img_list[0]######### "WOFGA" FIX labeling issue when restarting labeling #######
            except:######### "WOFGA" FIX labeling issue when restarting labeling #######
                print('NO_IMG_TO_SHOW')######### "WOFGA" FIX labeling issue when restarting labeling #######
            self.cur_img_idx = 0
        else:
